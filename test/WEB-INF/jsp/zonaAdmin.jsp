...
<html>
	...
	<div id='contenedorHorizontalTop'>
		...
		<div id="contenedorNav">
			...
			<div id="search">
				<img src='src/images/buscar.png'> </img><input type="text" name="buscar" id="buscador" disabled>
			</div>
			<div id="menu">
				<div id='cssmenu'>
					<ul>
	...
	<div id='contenedorHorizontalProd'>
		<div id="contenedorProd" style="background-color: rgba(230,100,50,1);margin-top: -20px;">
			<div id="contenido">
				<div class="enlacePanel">
					<a href='consultar?usuarios'> Usuarios </a>
				</div>
				<div class="enlacePanel">
					<a href='consultar?productos'> Productos </a>
				</div>
				<div class="enlacePanel">
					<a href='consultar?estadisticas'> Estadísticas </a>
				</div>
			</div>
		</div>
	</div>
	<div id='contenedorHorizontalBottom' style='margin-top: -34px;'>
